...
function StudentForm() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:5000/teacher", {
        name,
        fatherName,
        age,
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label className="form-label">
              Please Select Class You want to teach!!
            </label>
          ...
          <div className="mb-3">
            <label className="form-label">Choose the Subjects!!</label>
            <div style={{ display: "flex" }}>
          ...
          <button
            type="submit"
            className="btn btn-primary bg-primary text-white  w-45 "
          >
            Submit
          </button>
        </form>
